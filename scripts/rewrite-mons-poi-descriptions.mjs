/**
 * Réécrit les descriptions POI Tropéa en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-tropea-poi-descriptions.mjs
 */
import fs from "fs";
